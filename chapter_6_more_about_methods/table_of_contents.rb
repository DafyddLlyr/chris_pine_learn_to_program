...
chapter_1 = "Chapter 1: Getting Started".ljust(50) + "page 1".rjust(20)
chapter_2 = "Chapter 2: Numbers".ljust(50) + "page 9".rjust(20)
chapter_3 = "Chapter 3: Letters".ljust(50) + "page 13".rjust(20)
